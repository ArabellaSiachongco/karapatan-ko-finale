...
const Admin_Palmer = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(palmer_query, (snapshot) => {
      ...
      snapshot.forEach((doc) => {
        ...
        if (appointment.lawyer?.name !== PALMER_NAME) return; // ?.checking the lawyer
