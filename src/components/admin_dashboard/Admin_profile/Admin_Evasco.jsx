...
const Admin_Evasco = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(evasco_query, (snapshot) => {
      ...
      snapshot.forEach((doc) => {
        ...
        if (appointment.lawyer?.name !== EVASCO_NAME) return; // ?.checking the lawyer
