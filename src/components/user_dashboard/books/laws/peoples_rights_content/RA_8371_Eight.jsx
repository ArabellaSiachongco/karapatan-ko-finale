...
import chapterEight from "../../pages/book_peoples_right/chapterEight.json";
...
const ChapterEight = () => {
  ...
  const handleNextArticleClick = () => navigate("/RA_8371_Nine");
  const handlePrevArticleClick = () => navigate("/RA_8371_Seven");
  ...
  return (
    <div className="text-spacing-3 leading-relaxed tracking-wide">
      <ScrollWrapper>
        <div>
          {chapterEight.chapterEight.map((item) => (
