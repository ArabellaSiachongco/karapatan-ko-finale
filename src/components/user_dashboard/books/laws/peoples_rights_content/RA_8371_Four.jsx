...
import chapterFour from "../../pages/book_peoples_right/chapterFour.json";
...
const ChapterFour = () => {
  ...
  const handleNextArticleClick = () => {
    navigate("/RA_8371_Five");
  };

  const handlePrevArticleClick = () => {
    navigate("/RA_8371_Three");
  };
  ...
  return (
    <div className="text-spacing-3 leading-relaxed tracking-wide">
      <ScrollWrapper>
        <div>
          {chapterFour.chapterFour.map((item) => (
...
export default SectionWrapper(ChapterFour);
