...
import chapterSix from "../../pages/book_peoples_right/chapterSix.json";
...
const ChapterSix = () => {
  ...
  return (
    <div className="text-spacing-3 leading-relaxed tracking-wide">
      <ScrollWrapper>
        <div>
          {chapterSix.chapterSix.map((item) => (
...
export default SectionWrapper(ChapterSix);
