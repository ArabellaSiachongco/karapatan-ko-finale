...
import familyTwelve from "../../pages/book_family_code/familyTwelve.json";
...
const FamilyTwelve = () => {
  ...
  return (
    <div className="text-spacing-3 leading-relaxed tracking-wide">
      <ScrollWrapper>
        <div>
          <h4 className={`${styles.headText} mb-10`}>{familyTwelve.chapter}</h4>
          {familyTwelve.articles.map((item, index) => (
            <div key={index} className="my-5">
              ...
              {item.content &&
                Object.entries(item.content).map(([key, value], contentIndex) => (
                  <div key={contentIndex} className="my-3">
...
export default SectionWrapper(FamilyTwelve);
