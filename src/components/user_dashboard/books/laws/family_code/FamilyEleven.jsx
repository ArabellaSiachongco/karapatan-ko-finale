...
import familyEleven from "../../pages/book_family_code/familyEleven.json";
      ...
      <ScrollWrapper>
        <div>
          <h4 className={`${styles.headText} mb-10`}>
            {familyEleven["Chapter 6"].title}
          </h4>
          {familyEleven["Chapter 6"].articles.map((article) => (
...
export default SectionWrapper(FamilyEleven);
