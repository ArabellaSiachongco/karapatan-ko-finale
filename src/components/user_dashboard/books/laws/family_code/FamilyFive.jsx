...
import familyFive from "../../pages/book_family_code/familyFive.json";
...
const FamilyFive = () => {
  ...
  return (
    <div className="text-spacing-3 leading-relaxed tracking-wide">
      <ScrollWrapper>
        <div>
          <h4 className={`${styles.headText} mb-10`}>{familyFive.title}</h4>
          {familyFive.articles.map((item, index) => (
...
export default SectionWrapper(FamilyFive);
