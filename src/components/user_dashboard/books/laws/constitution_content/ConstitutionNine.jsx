...
import commissions from "../../pages/book_constitution/commission.json";
import civil from "../../pages/book_constitution/civil.json";
import election from "../../pages/book_constitution/election.json";
import audit from "../../pages/book_constitution/audit.json";
...
const ArticleNine = () => {
  ...
  const handleNextArticleClick = () => {
    navigate("/constitutionTen");
  };

  const handlePrevArticleClick = () => {
    navigate("/constitutionEight");
  };
