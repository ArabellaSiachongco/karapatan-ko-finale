...
import economy from "../../pages/book_constitution/economy.json";
...
const ArticleTwelve = () => {
  ...
  const handleNextArticleClick = () => {
    navigate("/constitutionThirteen");
  };

  const handlePrevArticleClick = () => {
    navigate("/constitutionEleven");
  };
...
export default SectionWrapper(ArticleTwelve);
