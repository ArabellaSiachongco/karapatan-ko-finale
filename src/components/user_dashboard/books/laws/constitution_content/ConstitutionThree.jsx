...
import bill from "../../pages/book_constitution/bill.json";
...
const ArticleThree = () => {
  ...
  // visibility of the scroll-to-top button
  useEffect(() => {
    const handleScroll = () => {
...
export default SectionWrapper(ArticleThree);
