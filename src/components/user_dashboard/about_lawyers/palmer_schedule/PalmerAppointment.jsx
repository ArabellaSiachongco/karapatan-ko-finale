  ...
  return (
    <div>
        ...
        <tbody>
          ...
          <tr>
            <td
              className={`${styles.appointmentSubTextLower} border border-gray-300 p-3`}
            >
              3. Dumating sa Magalgalit Law Office ng hindi bababa sa labinlimang minuto
              bago ang nakatakdang oras ng appointment.
              <br />
              <i>
          ...
          <tr>
            <td className="p-3 text-sm">
              <Link to="/terms-and-conditions_palmer">
      ...
      <div className="flex justify-between mt-10">
        ...
        <Link
          to={isChecked ? "/appointmentTableLawyer1" : "#"}
...
export default SectionWrapper(PalmerAppointment);
